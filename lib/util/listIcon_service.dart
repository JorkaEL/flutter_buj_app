...
class ListIconService {
  ListIconService._internal();

  static final ListIconService _listIconService = ListIconService._internal();

  factory ListIconService() {
    return _listIconService;
  }
